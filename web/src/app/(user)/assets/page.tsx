...
export default function AssetsPage() {
    ...
    const openEdit = (asset: Asset) => {
        ...
        form.setFieldsValue({
            ...
            source: asset.source,
            note: asset.note,
            content: asset.kind === "text" ? asset.data.content : asset.kind === "image" ? asset.data.dataUrl : asset.kind === "video" || asset.kind === "audio" ? asset.data.url : "",
        });
        setIsAssetOpen(true);
    };
    ...
    const saveAsset = async () => {
        ...
        if (values.kind === "text") {
            ...
            const asset = { ...base, coverUrl: base.coverUrl || data.dataUrl, kind: "image" as const, data };
            editingAsset ? updateAsset(editingAsset.id, asset) : addAsset(asset);
